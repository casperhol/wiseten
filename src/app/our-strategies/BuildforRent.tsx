  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mt-20 text-center mb-10">
        <h3 className="text-2xl md:text-3xl font-bold mb-2">Build-For-Rent.</h3>
        <p className="text-lg font-medium mb-4">2301 Single-family Homes</p>
